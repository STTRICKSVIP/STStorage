# Don't Remove Credit Tg - @STConQ
# Subscribe YouTube Channel For Amazing Bot https://youtube.com/@strajanr
# Ask Doubt on telegram @STConQ
...
CDB_NAME = environ.get("CDB_NAME", "cloneSTStoragebot")
...
VERIFY_TUTORIAL = environ.get("VERIFY_TUTORIAL", "https://t.me/BGMIFUCKER/1670") # how to open link 

# Website Info:
WEBSITE_URL_MODE = bool(environ.get('WEBSITE_URL_MODE', True)) # Set True or False

# If Website Url Mode Is True Then Fill All Required Variable, If False Then Don't Fill.
WEBSITE_URL = environ.get("WEBSITE_URL", "https://ststorage.blogspot.com/2025/03/st-tricks.html") # For More Information Check Video On Yt - @Tech_VJ
